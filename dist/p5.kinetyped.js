...
function ya(e, r) {
  this.source = e, this.sourceIndex = 0, this.tag = 0, this.bitcount = 0, this.dest = r, this.destLen = 0, this.ltree = new Re(), this.dtree = new Re();
}
var Tt = new Re(), kt = new Re(), Fr = new Uint8Array(30), Ur = new Uint16Array(30), Ft = new Uint8Array(30), Ut = new Uint16Array(30), xa = new Uint8Array([
  16,
  17,
  18,
  0,
  ...
  1,
  15
]), Mr = new Re(), se = new Uint8Array(288 + 32);
function Ct(e, r, t, a) {
  var n, s;
  for (n = 0; n < t; ++n)
    e[n] = 0;
...
function Gr(e, r, t) {
  for (; ; ) {
    ...
    if (a < 256)
      ...
      var n, s, i, u;
      for (a -= 257, n = ie(e, Fr[a], Ur[a]), s = vr(e, t), i = e.destLen - ie(e, Ft[s], Ut[s]), u = i; u < i + n; ++u)
...
function ka(e) {
  ...
  return e.bitcount = 0, kr;
}
function Fa(e, r) {
  var t = new ya(e, r), a, n, s;
  do {
    switch (a = Sa(t), n = ie(t, 2, 0), n) {
      case 0:
        s = ka(t);
        break;
      case 1:
        ...
        break;
      case 2:
        Ta(t, t.ltree, t.dtree), s = Gr(t, t.ltree, t.dtree);
        break;
      default:
        s = St;
    }
...
he.prototype.addPoint = function(e, r) {
...
he.prototype.addBezier = function(e, r, t, a, n, s, i, u) {
  ...
  for (var p = 0; p <= 1; p++) {
    ...
    if (d === 0) {
      if (c === 0)
        continue;
      var m = -x / c;
      0 < m && m < 1 && (p === 0 && this.addX(ke(o[p], l[p], f[p], h[p], m)), p === 1 && this.addY(ke(o[p], l[p], f[p], h[p], m)));
      continue;
    }
    var y = Math.pow(c, 2) - 4 * x * d;
    if (!(y < 0)) {
      var C = (-c + Math.sqrt(y)) / (2 * d);
      0 < C && C < 1 && (p === 0 && this.addX(ke(o[p], l[p], f[p], h[p], C)), p === 1 && this.addY(ke(o[p], l[p], f[p], h[p], C)));
      var S = (-c - Math.sqrt(y)) / (2 * d);
      0 < S && S < 1 && (p === 0 && this.addX(ke(o[p], l[p], f[p], h[p], S)), p === 1 && this.addY(ke(o[p], l[p], f[p], h[p], S)));
    }
  }
};
he.prototype.addQuad = function(e, r, t, a, n, s) {
...
P.prototype.getBoundingBox = function() {
  for (var e = new he(), r = 0, t = 0, a = 0, n = 0, s = 0; s < this.commands.length; s++) {
...
var U = { fail: Et, argument: Nr, assert: Nr }, Hr = 32768, zr = 2147483648, Ue = {}, g = {}, E = {};
function ae(e) {
  return function() {
    return e;
  };
...
E.USHORT = ae(2);
g.SHORT = function(e) {
  return e >= Hr && (e = -(2 * Hr - e)), [e >> 8 & 255, e & 255];
};
E.SHORT = ae(2);
g.UINT24 = function(e) {
...
E.ULONG = ae(4);
g.LONG = function(e) {
  return e >= zr && (e = -(2 * zr - e)), [e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, e & 255];
};
E.LONG = ae(4);
g.FIXED = g.ULONG;
E.FIXED = E.ULONG;
...
Ue.UTF8 = function(e, r, t) {
  for (var a = [], n = t, s = 0; s < n; s++, r += 1)
    a[s] = e.getUint8(r);
  return String.fromCharCode.apply(null, a);
};
Ue.UTF16 = function(e, r, t) {
...
var ze = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap(), _e, Ca = function(e) {
  if (!_e) {
    _e = {};
    for (var r in dr)
      _e[r] = new String(r);
...
g.VARDELTAS = function(e) {
  for (var r = 0, t = []; r < e.length; ) {
    var a = e[r];
    a === 0 ? r = Ea(e, r, t) : a >= -128 && a <= 127 ? r = Oa(e, r, t) : r = La(e, r, t);
  }
  return t;
};
g.INDEX = function(e) {
...
function Qe(e) {
  e.format === 1 ? z.call(
    this,
    "coverageTable",
    [{ name: "coverageFormat", type: "USHORT", value: 1 }].concat(De("glyph", e.glyphs))
  ) : e.format === 2 ? z.call(
    this,
    "coverageTable",
    [{ name: "coverageFormat", type: "USHORT", value: 2 }].concat(Ae("rangeRecord", e.ranges, function(r) {
      return [
...
function Ke(e) {
  z.call(
    this,
    "scriptListTable",
    Ae("scriptRecord", e, function(r, t) {
      ...
      return U.assert(!!n, "Unable to write GSUB: script " + r.tag + " has no default language system."), [
        ...
        { name: "script" + t, type: "TABLE", value: new z("scriptTable", [
          { name: "defaultLangSys", type: "TABLE", value: new z("defaultLangSys", [
            { name: "lookupOrder", type: "USHORT", value: 0 },
            { name: "reqFeatureIndex", type: "USHORT", value: n.reqFeatureIndex }
          ].concat(De("featureIndex", n.featureIndexes))) }
        ].concat(Ae("langSys", a.langSysRecords, function(s, i) {
          var u = s.langSys;
          return [
            { name: "langSysTag" + i, type: "TAG", value: s.tag },
            { name: "langSys" + i, type: "TABLE", value: new z("langSys", [
              { name: "lookupOrder", type: "USHORT", value: 0 },
              { name: "reqFeatureIndex", type: "USHORT", value: u.reqFeatureIndex }
            ].concat(De("featureIndex", u.featureIndexes))) }
          ];
        }))) }
      ];
    })
...
function Je(e) {
  z.call(
    this,
    "featureListTable",
    Ae("featureRecord", e, function(r, t) {
      var a = r.feature;
      return [
        { name: "featureTag" + t, type: "TAG", value: r.tag },
        { name: "feature" + t, type: "TABLE", value: new z("featureTable", [
          { name: "featureParams", type: "USHORT", value: a.featureParams }
        ].concat(De("lookupListIndex", a.lookupListIndexes))) }
      ];
    })
  );
}
...
function je(e, r) {
  z.call(this, "lookupListTable", mr("lookup", e, function(t) {
    ...
    ].concat(mr("subtable", t.subtables, a)));
  }));
}
je.prototype = Object.create(z.prototype);
je.prototype.constructor = je;
...
v.prototype.parseLongDateTime = function() {
  var e = Cr(this.data, this.offset + this.relativeOffset + 4);
  return e -= 2082844800, this.relativeOffset += 8, e;
};
v.prototype.parseVersion = function(e) {
  var r = $e(this.data, this.offset + this.relativeOffset), t = $e(this.data, this.offset + this.relativeOffset + 2);
  return this.relativeOffset += 4, e === void 0 && (e = 4096), r + t / e / 10;
};
v.prototype.skip = function(e, r) {
  r === void 0 && (r = 1), this.relativeOffset += Ia[e] * r;
};
...
v.prototype.parseScriptList = function() {
  return this.parsePointer(v.recordList({
    tag: v.tag,
    script: v.pointer({
      defaultLangSys: v.pointer(Wr),
      langSysRecords: v.recordList({
        tag: v.tag,
        langSys: v.pointer(Wr)
      })
    })
  })) || [];
};
...
Rt.prototype.charToGlyphIndex = function(e) {
  ...
  switch (e.version) {
    ...
    case 2:
      ...
      for (var r = 0; r < e.numberOfGlyphs; r++)
        e.glyphNameIndex[r] < be.length ? this.names[r] = be[e.glyphNameIndex[r]] : this.names[r] = e.names[e.glyphNameIndex[r] - be.length];
      break;
    case 2.5:
      this.names = new Array(e.numberOfGlyphs);
      for (var t = 0; t < e.numberOfGlyphs; t++)
        this.names[t] = be[t + e.glyphNameIndex[t]];
      break;
    case 3:
      this.names = [];
      break;
...
Q.prototype.bindConstructorValues = function(e) {
  this.index = e.index || 0, this.name = e.name || null, this.unicode = e.unicode || void 0, this.unicodes = e.unicodes || e.unicode !== void 0 ? [e.unicode] : [], "xMin" in e && (this.xMin = e.xMin), "yMin" in e && (this.yMin = e.yMin), "xMax" in e && (this.xMax = e.xMax), "yMax" in e && (this.yMax = e.yMax), "advanceWidth" in e && (this.advanceWidth = e.advanceWidth), Object.defineProperty(this, "path", Za(this, e.path));
};
...
Q.prototype.getPath = function(e, r, t, a, n) {
  ...
  for (var f = new P(), h = 0; h < s.length; h += 1) {
    var p = s[h];
    p.type === "M" ? f.moveTo(e + p.x * u, r + -p.y * o) : p.type === "L" ? f.lineTo(e + p.x * u, r + -p.y * o) : p.type === "Q" ? f.quadraticCurveTo(
      e + p.x1 * u,
      r + -p.y1 * o,
      e + p.x * u,
      r + -p.y * o
...
Q.prototype.drawMetrics = function(e, r, t, a) {
  var n;
  r = r !== void 0 ? r : 0, t = t !== void 0 ? t : 0, a = a !== void 0 ? a : 24, n = 1 / this.path.unitsPerEm * a, e.lineWidth = 1, e.strokeStyle = "black", xe.line(e, r, -1e4, r, 1e4), xe.line(e, -1e4, t, 1e4, t);
  var s = this.xMin || 0, i = this.yMin || 0, u = this.xMax || 0, o = this.yMax || 0, l = this.advanceWidth || 0;
  e.strokeStyle = "blue", xe.line(e, r + s * n, -1e4, r + s * n, 1e4), xe.line(e, r + u * n, -1e4, r + u * n, 1e4), xe.line(e, -1e4, t + -i * n, 1e4, t + -i * n), xe.line(e, -1e4, t + -o * n, 1e4, t + -o * n), e.strokeStyle = "green", xe.line(e, r + l * n, -1e4, r + l * n, 1e4);
};
function Ve(e, r, t) {
...
function Ka(e, r, t, a, n, s) {
  return function() {
    ...
    }, Ve(i, "xMin", "_xMin"), Ve(i, "xMax", "_xMax"), Ve(i, "yMin", "_yMin"), Ve(i, "yMax", "_yMax"), i;
  };
}
function Ja(e, r, t, a) {
  return function() {
...
var ue = { GlyphSet: Or, glyphLoader: Qa, ttfGlyphLoader: Ka, cffGlyphLoader: Ja };
function Dt(e, r) {
  if (e === r)
    return !0;
...
function At(e, r, t) {
  ...
  for (t = t !== void 0 ? t : e.length; a.relativeOffset < t; ) {
    var i = a.parseByte();
    i <= 21 ? (i === 12 && (i = 1200 + a.parseByte()), n.push([i, s]), s = []) : s.push(rn(a, i));
  }
  return tn(n);
}
function Le(e, r) {
  return r <= 390 ? r = Xe[r] : r = e[r - 391], r;
}
function Bt(e, r, t) {
  for (var a = {}, n, s = 0; s < r.length; s += 1) {
    ...
    if (Array.isArray(i.type)) {
      ...
      for (var o = 0; o < i.type.length; o++)
        n = e[i.op] !== void 0 ? e[i.op][o] : void 0, n === void 0 && (n = i.value !== void 0 && i.value[o] !== void 0 ? i.value[o] : null), i.type[o] === "SID" && (n = Le(t, n)), u[o] = n;
      a[i.name] = u;
    } else
      n = e[i.op], n === void 0 && (n = i.value !== void 0 ? i.value : null), i.type === "SID" && (n = Le(t, n)), a[i.name] = n;
  }
  return a;
}
function an(e, r) {
...
function Vr(e, r, t, a) {
  for (var n = [], s = 0; s < t.length; s += 1) {
    var i = new DataView(new Uint8Array(t[s]).buffer), u = nn(i, a);
    ...
    if (o !== 0 && l !== 0) {
      ...
      if (u._defaultWidthX = f.defaultWidthX, u._nominalWidthX = f.nominalWidthX, f.subrs !== 0) {
        var h = l + f.subrs, p = de(e, h + r);
        u._subrs = p.objects, u._subrsBias = yr(u._subrs);
      }
      u._privateDict = f;
    }
    n.push(u);
...
function qr(e, r, t) {
  ...
  function D() {
    var F;
    F = o.length % 2 !== 0, F && !f && (w = o.shift() + y), l += o.length >> 1, o.length = 0, f = !0;
  }
  function L(F) {
    for (var G, Y, Z, j, $, M, N, _, W, V, H, X, A = 0; A < F.length; ) {
      var q = F[A];
      switch (A += 1, q) {
        case 1:
          D();
        ...
        case 3:
          ...
          break;
        case 4:
          o.length > 1 && !f && (w = o.shift() + y, f = !0), c += o.pop(), O(p, c);
          break;
        case 5:
          for (; o.length > 0; )
        ...
        case 12:
          switch (q = F[A], A += 1, q) {
            case 35:
              a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), N = s + o.shift(), _ = i + o.shift(), W = N + o.shift(), V = _ + o.shift(), H = W + o.shift(), X = V + o.shift(), p = H + o.shift(), c = X + o.shift(), o.shift(), u.curveTo(a, n, s, i, N, _), u.curveTo(W, V, H, X, p, c);
              break;
            case 34:
              a = p + o.shift(), n = c, s = a + o.shift(), i = n + o.shift(), N = s + o.shift(), _ = i, W = N + o.shift(), V = i, H = W + o.shift(), X = c, p = H + o.shift(), u.curveTo(a, n, s, i, N, _), u.curveTo(W, V, H, X, p, c);
              break;
            case 36:
              a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), N = s + o.shift(), _ = i, W = N + o.shift(), V = i, H = W + o.shift(), X = V + o.shift(), p = H + o.shift(), u.curveTo(a, n, s, i, N, _), u.curveTo(W, V, H, X, p, c);
              break;
            case 37:
              a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), N = s + o.shift(), _ = i + o.shift(), W = N + o.shift(), V = _ + o.shift(), H = W + o.shift(), X = V + o.shift(), Math.abs(H - p) > Math.abs(X - c) ? p = H + o.shift() : c = X + o.shift(), u.curveTo(a, n, s, i, N, _), u.curveTo(W, V, H, X, p, c);
              break;
            default:
          ...
          break;
        case 14:
          o.length > 0 && !f && (w = o.shift() + y, f = !0), h && (u.closePath(), h = !1);
          break;
        case 18:
          D();
          break;
        ...
        case 20:
          ...
          break;
        case 21:
          o.length > 2 && !f && (w = o.shift() + y, f = !0), c += o.pop(), p += o.pop(), O(p, c);
          break;
        case 22:
          o.length > 1 && !f && (w = o.shift() + y, f = !0), p += o.pop(), O(p, c);
          break;
        case 23:
          D();
          break;
...
function ln(e, r, t, a) {
  t.tables.cff = {};
  var n = an(e, r), s = de(e, n.endOffset, k.bytesToString), i = de(e, s.endOffset), u = de(e, i.endOffset, k.bytesToString), o = de(e, u.endOffset);
  t.gsubrs = o.objects, t.gsubrsBias = yr(t.gsubrs);
  var l = Vr(e, r, i.objects, u.objects);
  if (l.length !== 1)
  ...
  if (t.tables.cff.topDict = f, f._privateDict && (t.defaultWidthX = f._privateDict.defaultWidthX, t.nominalWidthX = f._privateDict.nominalWidthX), f.ros[0] !== void 0 && f.ros[1] !== void 0 && (t.isCIDFont = !0), t.isCIDFont) {
    ...
    h += r;
    var c = de(e, h), d = Vr(e, r, c.objects, u.objects);
    f._fdArray = d, p += r, f._fdSelect = un(e, p, t.numGlyphs, d.length);
  }
  var x = r + f.private[1], m = Pt(e, x, f.private[0], u.objects);
  if (t.defaultWidthX = m.defaultWidthX, t.nominalWidthX = m.nominalWidthX, m.subrs !== 0) {
    var y = x + m.subrs, C = de(e, y);
    t.subrs = C.objects, t.subrsBias = yr(t.subrs);
  } else
    t.subrs = [], t.subrsBias = 0;
  var S;
  a.lowMemory ? (S = ja(e, r + f.charStrings), t.nGlyphs = S.offsets.length) : (S = de(e, r + f.charStrings), t.nGlyphs = S.objects.length);
  var w = sn(e, r + f.charset, t.nGlyphs, u.objects);
  if (f.encoding === 0 ? t.cffEncoding = new er(_a, w) : f.encoding === 1 ? t.cffEncoding = new er(Wa, w) : t.cffEncoding = on(e, r + f.encoding, w), t.encoding = t.encoding || t.cffEncoding, t.glyphs = new ue.GlyphSet(t), a.lowMemory)
    t._push = function(L) {
      var F = $a(L, S.offsets, e, r + f.charStrings);
      t.glyphs.push(L, ue.cffGlyphLoader(t, L, qr, F));
    };
  else
    for (var O = 0; O < t.nGlyphs; O += 1) {
      var D = S.objects[O];
      t.glyphs.push(O, ue.cffGlyphLoader(t, O, qr, D));
    }
}
function Gt(e, r) {
  var t, a = Xe.indexOf(e);
  return a >= 0 && (t = a), a = r.indexOf(e), a >= 0 ? t = a + Xe.length : (t = Xe.length + r.length, r.push(e)), t;
}
function fn() {
...
function Nt(e, r, t) {
  for (var a = {}, n = 0; n < e.length; n += 1) {
    ...
    i !== void 0 && !Dt(i, s.value) && (s.type === "SID" && (i = Gt(i, t)), a[s.op] = { name: s.name, type: s.type, value: i });
  }
  return a;
}
function Xr(e, r) {
...
function yn(e, r) {
  ...
  var l = [];
  t.header = fn(), t.nameIndex = pn([r.postScriptName]);
  var f = Xr(n, l);
  t.topDictIndex = Yr(f), t.globalSubrIndex = cn(), t.charsets = vn(i, l), t.charStringsIndex = gn(e), t.privateDict = mn(s, l), t.stringIndex = hn(l);
  var h = t.header.sizeOf() + t.nameIndex.sizeOf() + t.topDictIndex.sizeOf() + t.stringIndex.sizeOf() + t.globalSubrIndex.sizeOf();
  return n.charset = h, n.encoding = 0, n.charStrings = n.charset + t.charsets.sizeOf(), n.private[1] = n.charStrings + t.charStringsIndex.sizeOf(), f = Xr(n, l), t.topDictIndex = Yr(f), t;
}
var Ht = { parse: ln, make: yn };
function xn(e, r) {
...
var _t = { parse: Sn, make: Tn };
function kn(e, r, t, a, n) {
...
function Un(e, r, t, a, n, s, i) {
  i.lowMemory ? Fn(e, r, t, a, n) : kn(r, t, a, n, s);
}
function Cn(e) {
...
function In(e, r, t) {
  for (var a = {}, n = new k.Parser(e, r), s = n.parseUShort(), i = n.parseUShort(), u = n.offset + n.parseUShort(), o = 0; o < i; o++) {
    var l = n.parseUShort(), f = n.parseUShort(), h = n.parseUShort(), p = n.parseUShort(), c = Xt[p] || p, d = n.parseUShort(), x = n.parseUShort(), m = Dn(l, h, t), y = Qt(l, f, h);
    if (y !== void 0 && m !== void 0) {
      var C = void 0;
      if (y === xr ? C = Ue.UTF16(e, u + x, d) : C = Ue.MACSTRING(e, u + x, d, y), C) {
        var S = a[c];
...
function Pn(e, r) {
  ...
  for (var o = ir(Yt), l = ir(Zt), f = [], h = [], p = 0; p < a.length; p++) {
    t = a[p];
    var c = n[t];
    for (var d in c) {
      var x = c[d], m = 1, y = o[d], C = Rn[y], S = Qt(m, C, y), w = g.MACSTRING(x, S);
      w === void 0 && (m = 0, y = r.indexOf(d), y < 0 && (y = r.length, r.push(d)), C = 4, w = g.UTF16(x));
      var O = Qr(w, h);
      f.push(Zr(
        m,
        C,
...
var Sr = { parse: Nn, make: Hn, unicodeRanges: br, getUnicodeRange: Gn };
function zn(e, r) {
  var t = {}, a = new k.Parser(e, r);
  switch (t.version = a.parseVersion(), t.italicAngle = a.parseFixed(), t.underlinePosition = a.parseShort(), t.underlineThickness = a.parseShort(), t.isFixedPitch = a.parseULong(), t.minMemType42 = a.parseULong(), t.maxMemType42 = a.parseULong(), t.minMemType1 = a.parseULong(), t.maxMemType1 = a.parseULong(), t.version) {
    ...
    case 2:
      ...
      for (var s = 0; s < t.numberOfGlyphs; s++)
        if (t.glyphNameIndex[s] >= be.length) {
          var i = a.parseChar();
...
var Jt = { parse: zn, make: _n }, ee = new Array(9);
ee[1] = function() {
...
ee[5] = function() {
    ...
    return {
      ...
      ruleSets: this.parseListOfLists(function() {
        ...
        return {
          ...
          lookupRecords: this.parseRecordList(i, Fe)
        };
      })
    };
  if (t === 2)
  ...
  if (t === 3) {
    ...
    return {
      ...
      lookupRecords: this.parseRecordList(n, Fe)
    };
  }
    ...
    return {
      ...
      chainRuleSets: this.parseListOfLists(function() {
        return {
          ...
          lookupRecords: this.parseRecordList(Fe)
        };
      })
    };
  if (t === 2)
...
Ce[4] = function(r) {
  return U.assert(r.substFormat === 1, "Lookup type 4 substFormat must be 1."), new b.Table("substitutionTable", [
    ...
    return new b.Table("ligatureSetTable", b.tableList("ligature", t, function(a) {
      return new b.Table(
        "ligatureTable",
        [{ name: "ligGlyph", type: "USHORT", value: a.ligGlyph }].concat(b.ushortList("component", a.components, a.components.length + 1))
      );
    }));
  })));
};
...
function Vn(e) {
  return new b.Table("GSUB", [
    ...
    { name: "lookups", type: "TABLE", value: new b.LookupList(e.lookups, Ce) }
  ]);
}
var jt = { parse: Wn, make: Vn };
function qn(e, r) {
  var t = new k.Parser(e, r), a = t.parseULong();
  U.argument(a === 1, "Unsupported META table version."), t.parseULong(), t.parseULong();
  for (var n = t.parseULong(), s = {}, i = 0; i < n; i++) {
    var u = t.parseTag(), o = t.parseULong(), l = t.parseULong(), f = Ue.UTF8(e, r + o, l);
    s[u] = f;
  }
  return s;
}
...
function ea(e) {
  ...
  var t = Math.pow(2, Kr(r.numTables));
  r.searchRange = 16 * t, r.entrySelector = Kr(t), r.rangeShift = r.numTables * 16 - r.searchRange;
  for (var a = [], n = [], s = r.sizeOf() + Jr().sizeOf() * r.numTables; s % 4 !== 0; )
    s += 1, n.push({ name: "padding", type: "BYTE", value: 0 });
  for (var i = 0; i < e.length; i += 1) {
    var u = e[i];
    U.argument(u.tableName.length === 4, "Table name" + u.tableName + " is invalid.");
    var o = u.sizeOf(), l = Jr(u.tableName, Lr(u.encode()), s, o);
...
function Zn(e) {
  ...
  var w = zt.make({
  ...
  }), D = qt.make(e.glyphs.length), L = Sr.make(Object.assign({
    ...
    ulCodePageRange1: 1,
    sxHeight: jr(e, "xyvw", { yMax: Math.round(S.ascender / 2) }).yMax,
    sCapHeight: jr(e, "HIKLEFJMNTZBDPRAGOQSUVWXY", S).yMax,
    usDefaultChar: e.hasChar(" ") ? 32 : 0,
    usBreakChar: e.hasChar(" ") ? 32 : 0
  }, e.tables.os2)), F = Wt.make(e.glyphs), G = Lt.make(e.glyphs), Y = e.getEnglishName("fontFamily"), Z = e.getEnglishName("fontSubfamily"), j = Y + " " + Z, $ = e.getEnglishName("postScriptName");
  $ || ($ = Y.replace(/\s/g, "") + "-" + Z);
  var M = {};
  ...
  var _ = [], W = Kt.make(M, _), V = _.length > 0 ? Vt.make(_) : void 0, H = Jt.make(), X = Ht.make(e.glyphs, {
  ...
  }), A = e.metas && Object.keys(e.metas).length > 0 ? $t.make(e.metas) : void 0, q = [w, O, D, L, W, G, H, X, F];
  V && q.push(V), e.tables.gsub && q.push(jt.make(e.tables.gsub)), A && q.push(A);
  for (var ar = ea(q), ga = ar.encode(), ma = Lr(ga), nr = ar.fields, Ir = !1, He = 0; He < nr.length; He += 1)
    if (nr[He].name === "head table") {
      nr[He].value.checkSumAdjustment = 2981146554 - ma, Ir = !0;
      break;
    }
  if (!Ir)
...
var Qn = { make: ea, fontToTable: Zn, computeCheckSum: Lr };
function or(e, r) {
...
Ie.prototype = {
  ...
  getScriptTable: function(e, r) {
    ...
    if (t) {
      e = e || "DFLT";
      var a = t.scripts, n = or(t.scripts, e);
      if (n >= 0)
        return a[n].script;
      if (r) {
        var s = {
...
Me.prototype.getKerningTables = function(e, r) {
...
K.prototype.addSingle = function(e, r, t, a) {
  var n = this.getLookupTables(t, a, e, 1, !0)[0], s = wr(n, 2, {
    substFormat: 2,
...
K.prototype.addMultiple = function(e, r, t, a) {
  ...
  var n = this.getLookupTables(t, a, e, 2, !0)[0], s = wr(n, 1, {
    substFormat: 1,
    coverage: { format: 1, glyphs: [] },
    sequences: []
  });
...
K.prototype.addAlternate = function(e, r, t, a) {
  var n = this.getLookupTables(t, a, e, 3, !0)[0], s = wr(n, 1, {
    substFormat: 1,
    coverage: { format: 1, glyphs: [] },
    alternateSets: []
  });
...
function ta(e, r, t) {
  ...
  if (e.numberOfContours > 0) {
    ...
    if (U.argument(n.length === l, "Bad flags."), i.length > 0) {
      ...
      if (l > 0) {
        ...
        for (var m = 0, y = 0; y < l; y += 1)
          s = n[y], d = c[y], d.x = rt(a, s, m, 2, 16), m = d.x;
        for (var C = 0, S = 0; S < l; S += 1)
          s = n[S], d = c[S], d.y = rt(a, s, C, 4, 32), C = d.y;
      }
      e.points = c;
    } else
      e.points = [];
    ...
    for (var w = !0; w; ) {
      ...
      (n & 1) > 0 ? (n & 2) > 0 ? (O.dx = a.parseShort(), O.dy = a.parseShort()) : O.matchedPoints = [a.parseUShort(), a.parseUShort()] : (n & 2) > 0 ? (O.dx = a.parseChar(), O.dy = a.parseChar()) : O.matchedPoints = [a.parseByte(), a.parseByte()], (n & 8) > 0 ? O.xScale = O.yScale = a.parseF2Dot14() : (n & 64) > 0 ? (O.xScale = a.parseF2Dot14(), O.yScale = a.parseF2Dot14()) : (n & 128) > 0 && (O.xScale = a.parseF2Dot14(), O.scale01 = a.parseF2Dot14(), O.scale10 = a.parseF2Dot14(), O.yScale = a.parseF2Dot14()), e.components.push(O), w = !!(n & 32);
    }
    if (n & 256) {
      e.instructionLength = a.parseUShort(), e.instructions = [];
  ...
  for (var t = $n(e), a = 0; a < t.length; ++a) {
    ...
    for (var l = 0; l < n.length; ++l)
      if (s = i, i = u, u = n[(l + 1) % n.length], i.onCurve)
        ...
        var f = u;
        s.onCurve || ((i.x + s.x) * 0.5, (i.y + s.y) * 0.5), u.onCurve || (f = { x: (i.x + u.x) * 0.5, y: (i.y + u.y) * 0.5 }), r.quadraticCurveTo(i.x, i.y, f.x, f.y);
      }
    r.closePath();
  }
  return r;
    ...
    for (var t = 0; t < r.components.length; t += 1) {
      ...
      if (n.getPath(), n.points) {
        ...
        if (a.matchedPoints === void 0)
          ...
          u = ur([u], o)[0], o.dx = i.x - u.x, o.dy = i.y - u.y, s = ur(n.points, o);
        }
...
function es(e, r, t, a) {
  for (var n = new ue.GlyphSet(a), s = 0; s < t.length - 1; s += 1) {
    var i = t[s], u = t[s + 1];
    i !== u ? n.push(s, ue.ttfGlyphLoader(a, s, ta, e, r + i, na)) : n.push(s, ue.glyphLoader(a, s));
  }
  return n;
}
function rs(e, r, t, a) {
...
function ts(e, r, t, a, n) {
  return n.lowMemory ? rs(e, r, t, a) : es(e, r, t, a);
}
var sa = { getPath: aa, parse: ts }, ia, Te, oa, Tr;
function ua(e) {
  this.font = e, this.getCommands = function(r) {
    return sa.getPath(r).commands;
...
Pe.prototype.distance = function(e, r, t, a) {
  return this.x * oe.distance(e, r, t, a) + this.y * le.distance(e, r, t, a);
};
Pe.prototype.interpolate = function(e, r, t, a) {
  var n, s, i, u, o, l, f;
...
Pe.prototype.setRelative = function(e, r, t, a, n) {
  a = a || this;
...
Pe.prototype.touch = function(e) {
  e.xTouched = !0, e.yTouched = !0;
};
function Ge(e, r) {
  var t = Math.sqrt(e * e + r * r);
  return e /= t, r /= t, e === 1 && r === 0 ? oe : e === 0 && r === 1 ? le : new Pe(e, r);
}
function pe(e, r, t, a) {
...
var Be = Object.freeze(new pe(0, 0)), us = {
  cvCutIn: 17 / 16,
  deltaBase: 9,
  deltaShift: 0.125,
  loop: 1,
...
function ge(e, r) {
  switch (this.env = e, this.stack = [], this.prog = r, e) {
    ...
    case "prep":
      this.fv = this.pv = this.dpv = oe, this.round = la;
  }
}
ua.prototype.exec = function(e, r) {
  if (typeof r != "number")
  ...
  if (!(this._errorState > 2)) {
    ...
    if (!a || a.ppem !== r) {
      ...
      if (!n) {
        ge.prototype = us, n = this._fpgmState = new ge("fpgm", t.tables.fpgm), n.funcs = [], n.font = t, exports.DEBUG && (console.log("---EXEC FPGM---"), n.step = -1);
        try {
          Te(n);
        } catch (l) {
      ...
      ge.prototype = n, a = this._prepState = new ge("prep", t.tables.prep), a.ppem = r;
      var s = t.tables.cvt;
      if (s)
...
oa = function(e, r) {
  ...
  if (ge.prototype = r, !n)
    u = new ge("glyf", e.instructions), exports.DEBUG && (console.log("---EXEC GLYPH---"), u.step = -1), Tr(e, u, t, a), i = u.gZone;
  else {
    var o = r.font;
    i = [], s = [];
    for (var l = 0; l < n.length; l++) {
      var f = n[l], h = o.glyphs.get(f.glyphIndex);
      u = new ge("glyf", h.instructions), exports.DEBUG && (console.log("---EXEC COMP " + l + "---"), u.step = -1), Tr(h, u, t, a);
    ...
    e.instructions && !u.inhibitGridFit && (u = new ge("glyf", e.instructions), u.gZone = u.z0 = u.z1 = u.z2 = i, u.contours = s, i.push(
      new pe(0, 0),
      new pe(Math.round(e.advanceWidth * t), 0)
    ), exports.DEBUG && (console.log("---EXEC COMPOSITE---"), u.step = -1), Te(u), i.length -= 2);
  }
  return i;
};
Tr = function(e, r, t, a) {
...
Te = function(e) {
  ...
  if (!!r) {
    ...
    for (e.ip = 0; e.ip < t; e.ip++) {
      if (exports.DEBUG && e.step++, a = ia[r[e.ip]], !a)
        throw new Error(
...
function st(e, r) {
  ...
  var u, o;
  e ? (u = s.y - i.y, o = i.x - s.x) : (u = i.x - s.x, o = i.y - s.y), r.pv = r.dpv = Ge(u, o);
}
function it(e, r) {
  var t = r.stack, a = t.pop(), n = t.pop(), s = r.z2[a], i = r.z1[n];
  exports.DEBUG && console.log("SFVTL[" + e + "]", a, n);
  var u, o;
  e ? (u = s.y - i.y, o = i.x - s.x) : (u = i.x - s.x, o = i.y - s.y), r.fv = Ge(u, o);
}
function ls(e) {
  var r = e.stack, t = r.pop(), a = r.pop();
  exports.DEBUG && console.log(e.step, "SPVFS[]", t, a), e.pv = e.dpv = Ge(a, t);
}
function fs(e) {
  var r = e.stack, t = r.pop(), a = r.pop();
  exports.DEBUG && console.log(e.step, "SPVFS[]", t, a), e.fv = Ge(a, t);
}
function ps(e) {
...
function vs(e) {
  ...
  var d = l.x, x = l.y, m = f.x, y = f.y, C = h.x, S = h.y, w = p.x, O = p.y, D = (d - m) * (S - O) - (x - y) * (C - w), L = d * y - x * m, F = C * O - S * w;
  c.x = (L * (C - w) - F * (d - m)) / D, c.y = (L * (S - O) - F * (x - y)) / D;
}
function ds(e) {
...
function ks(e) {
  exports.DEBUG && console.log(e.step, "RTG[]"), e.round = la;
}
function Fs(e) {
  exports.DEBUG && console.log(e.step, "RTHG[]"), e.round = ss;
}
function Us(e) {
  var r = e.stack.pop();
...
function Cs(e) {
  exports.DEBUG && console.log(e.step, "ELSE[]"), pa(e, !1);
}
function Es(e) {
  var r = e.stack.pop();
...
function As(e) {
  ...
  e.prog = e.funcs[t];
  for (var i = 0; i < a; i++)
    Te(e), exports.DEBUG && console.log(
      ++e.step,
...
function Bs(e) {
  ...
  var t = e.ip, a = e.prog;
  e.prog = e.funcs[r], Te(e), e.ip = t, e.prog = a, exports.DEBUG && console.log(++e.step, "returning from", r);
}
function Is(e) {
...
function ot(e, r) {
  ...
  var i = s.distance(a, Be);
  e && (i = r.round(i)), n.setRelative(a, Be, i, s), n.touch(a), r.rp0 = r.rp1 = t;
}
function ut(e, r) {
...
function lt(e, r) {
  for (var t = r.stack, a = e ? r.rp1 : r.rp2, n = (e ? r.z0 : r.z1)[a], s = r.fv, i = r.pv, u = r.loop, o = r.z2; u--; ) {
    ...
    s.setRelative(f, f, h, i), s.touch(f), exports.DEBUG && console.log(
      r.step,
...
function Ns(e) {
  for (var r = e.stack, t = e.rp1, a = e.rp2, n = e.loop, s = e.z0[t], i = e.z1[a], u = e.fv, o = e.dpv, l = e.z2; n--; ) {
    ...
    exports.DEBUG && console.log(
      ...
      "<->",
      a
    ), u.interpolate(h, s, i, o), u.touch(h);
  }
  e.loop = 1;
}
function ht(e, r) {
...
function Hs(e) {
  for (var r = e.stack, t = e.rp0, a = e.z0[t], n = e.loop, s = e.fv, i = e.pv, u = e.z1; n--; ) {
    ...
    exports.DEBUG && console.log(
      ...
      o
    ), s.setRelative(l, a, 0, i), s.touch(l);
  }
  e.loop = 1;
}
function zs(e) {
  exports.DEBUG && console.log(e.step, "RTDG[]"), e.round = ns;
}
function ct(e, r) {
  ...
  var l = u.distance(s, Be);
  e && (Math.abs(l - o) < r.cvCutIn && (l = o), l = r.round(l)), i.setRelative(s, Be, l, u), r.zp0 === 0 && (s.xo = s.x, s.yo = s.y), i.touch(s), r.rp0 = r.rp1 = n;
}
function _s(e) {
...
function vt(e, r) {
  ...
  exports.DEBUG && console.log(r.step, "GC[" + e + "]", a), t.push(r.dpv.distance(n, Be, e, !1) * 64);
}
function dt(e, r) {
...
function ni(e) {
  var r = e.stack.pop();
  exports.DEBUG && console.log(e.step, "IF[]", r), r || (pa(e, !0), exports.DEBUG && console.log(e.step, "EIF[]"));
}
function si(e) {
...
function bi(e) {
  var r = e.stack.pop();
  exports.DEBUG && console.log(e.step, "SROUND[]", r), e.round = fa;
  var t;
  switch (r & 192) {
    case 0:
      t = 0.5;
...
function Si(e) {
  var r = e.stack.pop();
  exports.DEBUG && console.log(e.step, "S45ROUND[]", r), e.round = fa;
  var t;
  switch (r & 192) {
    case 0:
      t = Math.sqrt(2) / 2;
...
function Ti(e) {
  exports.DEBUG && console.log(e.step, "ROFF[]"), e.round = as;
}
function ki(e) {
  exports.DEBUG && console.log(e.step, "RUTG[]"), e.round = is;
}
function Fi(e) {
  exports.DEBUG && console.log(e.step, "RDTG[]"), e.round = os;
}
function Ui(e) {
  var r = e.stack.pop();
...
function gt(e, r) {
  ...
  var u, o;
  e ? (u = s.y - i.y, o = i.x - s.x) : (u = i.x - s.x, o = i.y - s.y), r.dpv = Ge(u, o);
}
function Ci(e) {
...
function T(e, r, t, a, n, s) {
  ...
  m = x = d.distance(h, f, !0, !0), y = m >= 0 ? 1 : -1, m = Math.abs(m), e && (C = s.cvt[u], a && Math.abs(m - C) < s.cvCutIn && (m = C)), t && m < p && (m = p), a && (m = s.round(m)), c.setRelative(h, f, y * m, d), c.touch(h), exports.DEBUG && console.log(
    s.step,
    (e ? "MIRP[" : "MDRP[") + (r ? "M" : "m") + (t ? ">" : "_") + (a ? "R" : "_") + (n === 0 ? "Gr" : n === 1 ? "Bl" : n === 2 ? "Wh" : "") + "]",
    e ? u + "(" + s.cvt[u] + "," + C + ")" : "",
    o,
    "(d =",
    x,
...
function Ai(e) {
  ...
  a.forEach(function(n) {
    r.events[n].subscribe(
      r.updateContextsRanges
    );
  });
}
function B(e) {
  this.tokens = [], this.registeredContexts = {}, this.contextCheckers = [], this.events = {}, this.registeredModifiers = [], Ai.call(this, e);
}
...
B.prototype.replaceToken = function(e, r, t) {
  if (!isNaN(e) && this.inboundIndex(e) && r instanceof Ee) {
...
B.prototype.insertToken = function(e, r, t) {
  ...
  return a ? (this.tokens.splice.apply(
    this.tokens,
    [r, 0].concat(e)
...
B.prototype.dispatch = function(e, r) {
  ...
  a instanceof tr && a.subscribers.forEach(function(n) {
    n.apply(t, r || []);
  });
};
...
B.prototype.setEndOffset = function(e, r) {
  var t = this.getContext(r).openRange.startIndex, a = new Rr(t, e, r), n = this.getContext(r).ranges;
...
B.prototype.runContextCheck = function(e) {
  ...
  this.contextCheckers.forEach(function(a) {
    ...
    if (!s && a.checkStart(e) && (s = new Rr(t, null, n), r.getContext(n).openRange = s, r.dispatch("contextStart", [n, t])), !!s && a.checkEnd(e)) {
...
function Pi(e, r) {
  ...
  if (e.lookahead.length < r.lookaheadCoverage.length)
    return [];
  for (var s = e.lookahead.slice(n); s.length && ye(s[0].char); )
    s.shift();
  var i = new re(s, 0), u = hr(
    r.lookaheadCoverage,
    i
  ), o = [].concat(e.backtrack);
  for (o.reverse(); o.length && ye(o[0].char); )
    o.shift();
  if (o.length < r.backtrackCoverage.length)
    return [];
  var l = new re(o, 0), f = hr(
    r.backtrackCoverage,
    l
  ), h = a.length === r.inputCoverage.length && u.length === r.lookaheadCoverage.length && f.length === r.backtrackCoverage.length, p = [];
  if (h)
    for (var c = 0; c < r.lookupRecords.length; c++)
      for (var d = r.lookupRecords[c], x = d.lookupListIndex, m = this.getLookupByIndex(x), y = 0; y < m.subtables.length; y++) {
        var C = m.subtables[y], S = this.getLookupMethod(m, C), w = this.getSubstitutionType(m, C);
        if (w === "12")
...
function Gi(e, r) {
  var t = e.current, a = Ne(t, r.coverage);
  if (a === -1)
    return null;
...
J.prototype.lookupFeature = function(e) {
  ...
  for (var n = this.getFeatureLookups(a), s = [].concat(r.context), i = 0; i < n.length; i++)
    for (var u = n[i], o = this.getLookupSubtables(u), l = 0; l < o.length; l++) {
      ...
      switch (h) {
        case "11":
          c = p(r.current), c && s.splice(t, 1, new Se({
            id: 11,
            tag: e.tag,
            substitution: c
          }));
        ...
        case "12":
          ...
          break;
        case "63":
          c = p(r), Array.isArray(c) && c.length && s.splice(t, 1, new Se({
            id: 63,
            tag: e.tag,
            substitution: c
          }));
...
function Dr(e, r, t) {
  e instanceof Se && mt[e.id] && mt[e.id](e, r, t);
}
function Ki(e) {
  for (var r = [].concat(e.backtrack), t = r.length - 1; t >= 0; t--) {
    var a = r[t], n = ha(a), s = ye(a);
    if (!n && !s)
      return !0;
    if (n)
      return !1;
      ...
      if (!ye(u.char)) {
        ...
        if (a.indexOf(f) !== -1) {
          ...
          h.forEach(function(p, c) {
            p instanceof Se && (Dr(p, n, c), s.context[c] = p.substitution);
          });
        }
      }
    });
...
function $i(e) {
  var r = this, t = "arab", a = this.tokenizer.getRangeTokens(e), n = yt(a);
...
function ao(e) {
  var r = this, t = "latn", a = this.tokenizer.getRangeTokens(e), n = xt(a);
  n.context.forEach(function(s, i) {
    n.setCurrentIndex(i);
    var u = r.query.lookupFeature({
      tag: "liga",
...
ne.prototype.applyFeaturesToContexts = function() {
  this.checkContextReady("arabicWord") && (io.call(this), oo.call(this)), this.checkContextReady("latinWord") && uo.call(this), this.checkContextReady("arabicSentence") && so.call(this);
};
ne.prototype.processText = function(e) {
  (!this.text || this.text !== e) && (this.setText(e), no.call(this), this.applyFeaturesToContexts());
};
...
function R(e) {
  e = e || {}, e.tables = e.tables || {}, e.empty || (Oe(e.familyName, "When creating a new Font object, familyName is required."), Oe(e.styleName, "When creating a new Font object, styleName is required."), Oe(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."), Oe(e.ascender, "When creating a new Font object, ascender is required."), Oe(e.descender <= 0, "When creating a new Font object, negative descender value is required."), this.names = {
  ...
  })), this.supported = !0, this.glyphs = new ue.GlyphSet(this, e.glyphs || []), this.encoding = new wt(this), this.position = new Me(this), this.substitution = new K(this), this.tables = this.tables || {}, this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, "hinting", {
    get: function() {
      if (this._hinting)
        return this._hinting;
      if (this.outlinesFormat === "truetype")
        return this._hinting = new ua(this);
    }
  });
}
...
R.prototype.stringToGlyphs = function(e, r) {
...
R.prototype.getKerningValue = function(e, r) {
...
R.prototype.forEachGlyph = function(e, r, t, a, n, s) {
...
R.prototype.getPath = function(e, r, t, a, n) {
  var s = new P();
...
R.prototype.getPaths = function(e, r, t, a, n) {
  var s = [];
  return this.forEachGlyph(e, r, t, a, n, function(i, u, o, l) {
    var f = i.getPath(u, o, l, n, this);
    s.push(f);
...
R.prototype.getAdvanceWidth = function(e, r, t) {
  return this.forEachGlyph(e, 0, 0, r, t, function() {
  });
};
R.prototype.draw = function(e, r, t, a, n, s) {
  this.getPath(r, t, a, n, s).draw(e);
};
R.prototype.drawPoints = function(e, r, t, a, n, s) {
  this.forEachGlyph(r, t, a, n, s, function(i, u, o, l) {
    i.drawPoints(e, u, o, l);
  });
};
R.prototype.drawMetrics = function(e, r, t, a, n, s) {
  this.forEachGlyph(r, t, a, n, s, function(i, u, o, l) {
...
function co(e, r) {
  ...
  for (var a = 0; a < e.axes.length; a++)
    t.fields = t.fields.concat(lo(a, e.axes[a], r));
  for (var n = 0; n < e.instances.length; n++)
    t.fields = t.fields.concat(po(n, e.instances[n], e.axes, r));
  return t;
}
function vo(e, r, t) {
  ...
  for (var i = a.parseUShort(), u = a.parseUShort(), o = a.parseUShort(), l = a.parseUShort(), f = [], h = 0; h < i; h++)
    f.push(fo(e, r + s + h * u, t));
  for (var p = [], c = r + s + i * u, d = 0; d < o; d++)
    p.push(ho(e, c + d * l, f, t));
  return { axes: f, instances: p };
}
var go = { make: co, parse: vo }, mo = function() {
  return {
    coverage: this.parsePointer(v.coverage),
  ...
  return this.parseList(v.pointer(yo));
}, bo = function() {
  return {
    coverage: this.parsePointer(v.coverage),
    ligGlyphs: this.parseList(v.pointer(xo))
  };
}, So = function() {
...
function To(e, r) {
  ...
  var n = {
    ...
    attachList: t.parsePointer(mo),
    ligCaretList: t.parsePointer(bo),
    markAttachClassDef: t.parsePointer(v.classDef)
  };
  return a >= 1.2 && (n.markGlyphSets = t.parsePointer(So)), n;
}
var ko = { parse: To }, te = new Array(10);
te[1] = function() {
  var r = this.offset + this.relativeOffset, t = this.parseUShort();
  if (t === 1)
    return {
...
function Co(e) {
  return new b.Table("GPOS", [
    ...
    { name: "scripts", type: "TABLE", value: new b.ScriptList(e.scripts) },
    { name: "features", type: "TABLE", value: new b.FeatureList(e.features) },
    { name: "lookups", type: "TABLE", value: new b.LookupList(e.lookups, Uo) }
  ]);
}
var Eo = { parse: Fo, make: Co };
function Oo(e) {
  var r = {};
  e.skip("uShort");
  var t = e.parseUShort();
...
function bt(e, r) {
  for (var t = [], a = 12, n = 0; n < r; n += 1) {
    ...
    t.push({ tag: s, checksum: i, offset: u, length: o, compression: !1 }), a += 16;
  }
  return t;
}
function Mo(e, r) {
...
function I(e, r) {
  if (r.compression === "WOFF") {
    ...
    if (Ua(t, a), a.byteLength !== r.length)
...
function Br(e, r) {
  r = r == null ? {} : r;
  var t, a, n = new R({ empty: !0 }), s = new DataView(e, 0), i, u = [], o = k.getTag(s, 0);
  if (o === String.fromCharCode(0, 1, 0, 0) || o === "true" || o === "typ1")
    n.outlinesFormat = "truetype", i = k.getUShort(s, 4), u = bt(s, i);
  else if (o === "OTTO")
    n.outlinesFormat = "cff", i = k.getUShort(s, 4), u = bt(s, i);
  else if (o === "wOFF") {
    var l = k.getTag(s, 4);
    ...
    i = k.getUShort(s, 12), u = Mo(s, i);
  } else
    throw new Error("Unsupported OpenType signature " + o);
  for (var f, h, p, c, d, x, m, y, C, S, w, O, D = 0; D < i; D += 1) {
    var L = u[D], F = void 0;
    switch (L.tag) {
      case "cmap":
        F = I(s, L), n.tables.cmap = Lt.parse(F.data, F.offset), n.encoding = new Rt(n.tables.cmap);
        break;
      case "cvt ":
      ...
      case "fpgm":
        ...
        break;
      case "head":
        F = I(s, L), n.tables.head = zt.parse(F.data, F.offset), n.unitsPerEm = n.tables.head.unitsPerEm, t = n.tables.head.indexToLocFormat;
        break;
      case "hhea":
        F = I(s, L), n.tables.hhea = _t.parse(F.data, F.offset), n.ascender = n.tables.hhea.ascender, n.descender = n.tables.hhea.descender, n.numberOfHMetrics = n.tables.hhea.numberOfHMetrics;
        break;
      case "hmtx":
        m = L;
        break;
      case "ltag":
        F = I(s, L), a = Vt.parse(F.data, F.offset);
        break;
      case "maxp":
        F = I(s, L), n.tables.maxp = qt.parse(F.data, F.offset), n.numGlyphs = n.tables.maxp.numGlyphs;
        break;
      case "name":
        S = L;
        break;
      case "OS/2":
        F = I(s, L), n.tables.os2 = Sr.parse(F.data, F.offset);
        break;
      case "post":
        F = I(s, L), n.tables.post = Jt.parse(F.data, F.offset), n.glyphNames = new Er(n.tables.post);
        break;
      case "prep":
  ...
  var G = I(s, S);
  if (n.tables.name = Kt.parse(G.data, G.offset, a), n.names = n.tables.name, p && C) {
    var Y = t === 0, Z = I(s, C), j = Ao.parse(Z.data, Z.offset, n.numGlyphs, Y), $ = I(s, p);
    n.glyphs = sa.parse($.data, $.offset, j, n, r);
  } else if (f) {
    var M = I(s, f);
    Ht.parse(M.data, M.offset, n, r);
  } else
    throw new Error("Font doesn't contain TrueType or CFF outlines.");
  var N = I(s, m);
  if (Wt.parse(n, N.data, N.offset, n.numberOfHMetrics, n.numGlyphs, n.glyphs, r), Xa(n, r), y) {
    var _ = I(s, y);
    n.kerningPairs = Ro.parse(_.data, _.offset);
  } else
    n.kerningPairs = {};
  if (c) {
    var W = I(s, c);
    n.tables.gdef = ko.parse(W.data, W.offset);
  }
  if (d) {
    var V = I(s, d);
    n.tables.gpos = Eo.parse(V.data, V.offset), n.position.init();
  }
  if (x) {
    var H = I(s, x);
    n.tables.gsub = jt.parse(H.data, H.offset);
  }
  if (h) {
    var X = I(s, h);
    n.tables.fvar = go.parse(X.data, X.offset, n.names);
  }
  if (w) {
    var A = I(s, w);
    n.tables.meta = $t.parse(A.data, A.offset), n.metas = n.tables.meta;
  }
  return n;
}
function Po(e, r, t) {
  t = t == null ? {} : t;
  var a = typeof window > "u", n = a && !t.isUrl ? Bo : Io;
...
function Go(e, r) {
  var t = require("fs"), a = t.readFileSync(e);
  return Br(ra(a), r);
}
...
async function Zo(e) {
  ...
  try {
    if (we = await No.load(e), !we)
      throw new Error("Invalid font file.");
  } catch (r) {
    console.error(r);
  }
}
async function Qo(e, r, t, a) {
  if (typeof e != "number" || typeof r != "number" || typeof t != "number" || typeof a != "string")
    throw new Error(
      "[p5.kinetyped] generateGlyphs(x: number, y: number, fontSize: number, text: string): invalid parameters."
    );
  if (we.getAdvanceWidth(a, t), !we)
    throw new Error("[p5.kinetyped] generateGlyphs(): Font wasn't loaded yet. Glyphs can't be generated.");
  if (Ze = await we.getPaths(a, e, r, t), !Ze)
    throw new Error("[p5.kinetyped] generateGlyphs(): Glyphs couldn't be generated.");
  return Ze;
}
function Ko(e) {
  ({ points_all: va, points_separated: da } = Wo(Ze, e, null));
}
function Jo() {
  return va;
}
...
function Ho(e, r, t) {
  const a = [];
  let n = new fe.Vector(r.x, r.y), s = new fe.Vector(t.x, t.y);
  const i = s.dist(n), u = Math.floor(i / e);
  for (let o = 0; o < u; o++) {
    let l = fe.Vector.lerp(n, s, o / u);
    a.push(l);
  }
  return a;
}
function zo(e, r, t, a) {
  return fe.Vector.lerp(fe.Vector.lerp(e, r, a), fe.Vector.lerp(r, t, a), a);
}
function _o(e, r, t, a) {
  const n = [];
  let s = new fe.Vector(r.x, r.y), i = new fe.Vector(t.x, t.y), u = new fe.Vector(a.x, a.y);
  const l = Math.floor(30 / e);
  for (let f = 0; f < l; f++) {
    let h = f / l, p = zo(s, i, u, h);
    n.push(p);
  }
  return n;
}
function Wo(e, r, t = null) {
  let a = [], n = [], s = { x: 0, y: 0 }, i = !1;
  t && (console.log("[p5.kinetyped] Visualizing interpolation in canvas."), t.clear());
  for (const u of e) {
    let o = [], l = { shape: [], contour: [], all: [] }, f = !0;
    for (const h of u.commands)
      switch (h.type) {
        case "M": {
          !i && !f ? (l.all = l.all.concat(o), l.shape = o, o = [], i = !0) : l.contour.concat(o), s = { x: h.x, y: h.y }, f = !1;
          break;
        }
        case "L": {
          o = o.concat(Ho(r, s, h)), s = { x: h.x, y: h.y }, t && (t.vertex(h.x, h.y), Vo(t, s));
          break;
        }
        case "C": {
          console.error("Cubic bezier is not supported yet."), s = { x: h.x, y: h.y };
          break;
        }
        case "Q": {
          const p = { x: h.x1, y: h.y1 };
          o = o.concat(_o(r, s, p, h)), s = { x: h.x, y: h.y }, t && qo(t, h);
          break;
        }
      }
    i ? l.contour = o : l.shape = o, l.all = l.all.concat(o), i = !1, n.push(l), a = a.concat(l.shape.concat(l.contour));
  }
  return { points_separated: n, points_all: a };
}
function Vo(e, r) {
  e.push(), e.fill(220, 100, 100), e.noStroke(), e.circle(r.x, r.y, 5), e.pop();
}
function qo(e, r) {
  r.type == "Q" && (e.quadraticVertex(r.x1, r.y1, r.x, r.y), e.push(), e.fill(20, 100, 100), e.noStroke(), e.circle(r.x1, r.y1, 3), e.fill(220, 100, 100), e.circle(r.x, r.y, 3), e.pop());
}
export {
  Qo as generateGlyphs,
  Jo as getPoints,
  jo as getSeparatedPoints,
  Yo as hello_world,
  Ko as interpolateGlyphs,
  Wo as interpolate_glyphs,
  Zo as loadFont
};
